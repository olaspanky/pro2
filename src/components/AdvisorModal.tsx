  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok || response.status === 202) {
        ...
        // Close modal first, then navigate to the dedicated thank-you page
        onClose();
    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal-box">
        ...
        <p className="text-[var(--muted)] text-sm mb-6">
          Tell us about your business and we&apos;ll design the perfect solar solution for you.
        </p>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="af-row">
            <div className="af-group">
              ...
              <input id="af-name" name="af-name" type="text" placeholder="e.g. Chukwuemeka Obi"
                className={errors['af-name'] ? 'af-error' : ''} />
            </div>
            <div className="af-group">
              <label htmlFor="af-email">Business Email *</label>
              <input id="af-email" name="af-email" type="email" placeholder="e.g. emeka@company.ng"
                className={errors['af-email'] ? 'af-error' : ''} />
            </div>
          </div>
          <div className="af-row">
            <div className="af-group">
              <label htmlFor="af-phone">Phone Number *</label>
              <input id="af-phone" name="af-phone" type="tel" placeholder="e.g. 0802 906 8303"
                className={errors['af-phone'] ? 'af-error' : ''} />
            </div>
            <div className="af-group">
          ...
          <div className="af-group">
            ...
            <input id="af-location" name="af-location" type="text"
              placeholder="e.g. 12 Adeola Odeku St, Victoria Island, Lagos…"
              className={errors['af-location'] ? 'af-error' : ''} />
          </div>
          <div className="af-row">
            <div className="af-group">
