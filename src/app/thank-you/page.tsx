...
export const metadata = {
  ...
  description: 'Your consultation request has been received. A ProSolar advisor will be in touch within 24 hours.',
  robots: { index: false, follow: false }, // keep the page off search engine results
};
  ...
  return (
    <main className="ty-page">
      <div className="ty-card">
        ...
        <p className="ty-tag">Request Received</p>
        <h1 className="font-lora ty-heading">Thank You!</h1>
        <p className="ty-body">
          A <strong>ProSolar Energy</strong> advisor will contact you within{' '}
          <strong>24 hours</strong> to discuss your custom solar solution.
        </p>
